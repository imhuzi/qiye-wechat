package cn.tobdev.qy.weixin.sdk.api.school;

import cn.tobdev.qy.weixin.sdk.api.BaseApi;
import cn.tobdev.qy.weixin.sdk.api.school.param.SubscribeModelSetParam;
import cn.tobdev.qy.weixin.sdk.api.school.resp.ExternalContactDetailResp;
import cn.tobdev.qy.weixin.sdk.api.school.resp.ExternalcontactListResp;
import cn.tobdev.qy.weixin.sdk.api.school.resp.SubscribeModelGetResp;
import cn.tobdev.qy.weixin.sdk.api.school.resp.SubscribeQrCodeResp;
import cn.tobdev.qy.weixin.sdk.common.RespStatus;
import cn.tobdev.qy.weixin.sdk.constant.MessageApiUris;
import cn.tobdev.qy.weixin.sdk.constant.SchoolApiUris;
import feign.Param;
...
public interface SchoolApi extends BaseApi {
  ...
  /**
   * 获取外部联系人详情
   * {@link cn.tobdev.qy.weixin.sdk.api.customer.CustomerApi } get 方法一样,但是返回 数据字段不一样
   *
   * @return
   */
   ...
   *
   * 和 {@link cn.tobdev.qy.weixin.sdk.api.customer.CustomerApi } list 方法一样
   *
   * @param userid
   * @return
   */
